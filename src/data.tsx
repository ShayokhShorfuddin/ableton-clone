...
export const textBlockData: { heading: JSX.Element; subHeading: string }[] = [
	{
		heading: (
			<p className="text-lg sm:text-xl font-semibold">
				We make{" "}
				<a href="/" className="text-[#0000ff] hover:underline">
					Live
				</a>
				,{" "}
				<a href="/" className="text-[#0000ff] hover:underline">
